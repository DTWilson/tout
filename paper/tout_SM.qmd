...
For all our evaluations we will use an example problem where the outcome is binary with probability parameter $\rho$ and the null and alternative hypotheses are $\rho_0 = 0.5, \rho_1 = 0.7respectively.
 
## Section 5.1 (staistical efficiency) {-}
