...
Let the null and alternative hypotheses be $\rho_{0} = 0.5$ and
$\rho_{1} = 0.7$, and suppose we wish to control error rates at
$\alpha \leq 0.05,\beta \leq 0.2$ and $\gamma \leq 0.6$. We can find the
smallest possible design satisfying these constraints using the
