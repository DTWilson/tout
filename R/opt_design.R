#' Find optimal sample zize and progression criteria
#'
...
#' 
opt_design <-  function(rho_0, rho_1, alpha_nom, beta_nom, gamma_nom, max_n = NULL)
{
  min_n <- 2
  if(is.null(max_n)){
    ...
    n_two <- 0.25*(qnorm(1 - alpha_nom) - qnorm(beta_nom))^2/(rho_1 - rho_0)^2
