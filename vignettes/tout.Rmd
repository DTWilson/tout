...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = 0.5)
```
...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = 0.2)
```
...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = 0.4)
```
...
get_results <- function(z) {
  d <- tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = z)
...
get_true_ocs <- function(z) {
  d <- tout_design(n = z[1], x = c(z[2], z[3]), rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = 0.5)
  as.numeric(d[4:6])
}
...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 0.1)
```
...
get_results_gamma <- function(z) {
  d <- tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = z)
  return(c(d$n, d$thresholds))
}
...
ns <- sapply(df$tau, function(z) tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(z, z), max_n = 500, eta = 0.5)$n)
df$n <- ns
...
ns <- apply(df, 1, function(z) tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(z[1], z[1] + z[2]), max_n = 700, eta = 0.5)$n)
df$n <- ns
...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(0.1, 0.15), max_n = 8000, eta = 0.5)$n
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(0.0, 0.15), max_n = 8000, eta = 0.5)$n

tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(0.05, 0.05), max_n = 8000, eta = 0.5)$n
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, tau = c(0.01, 0.05), max_n = 8000, eta = 0.5)$n
```
...
```{r}
df <- data.frame(eta = seq(0.0501, 0.5, 0.001))
ns <- sapply(df$eta, function(z) tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = z, tau = c(0.05, 0.1), max_n = 500)$n)
df$n <- ns
...
```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.4, beta_nom = 0.1, gamma_nom = 0.5, tau = c(0, 0.05), max_n = 500)
```

## Extending to a continuous endpoint (wih known variance)

```{r}
tout_design(rho_0 = 0.5, rho_1 = 0.7, sigma = 0.5, alpha_nom = 0.05, beta_nom = 0.1, max_n = 500)
```
