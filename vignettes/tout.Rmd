...
get_true_ocs <- function(z) {
  d <- tout_design_bin(n = z[1], x = c(z[2], z[3]), rho_0 = 0.5, rho_1 = 0.7, alpha_nom = 0.05, beta_nom = 0.1, gamma = 1, eta = 0.5)
  as.numeric(d[4:6])
}
...
```{r}
tout_design_cont(rho_0 = 0.5, rho_1 = 0.7, sigma = 0.5, alpha_nom = 0.05, beta_nom = 0.1, max_n = 500)
```
